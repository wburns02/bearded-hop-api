...
async def run_seed(db: AsyncSession):
    ...
    # Detailed Recipes — full nested objects matching frontend TypeScript interfaces
    detailed_recipes = [
        DetailedRecipe(id=_id("recipe-1"), beer_id=_id("beer-1"), name="Hill Country Haze", style="New England IPA", category="flagship", version=3, batch_size=7, target_og=1.068, target_fg=1.015, target_abv=6.8, target_ibu=45, target_srm=5, boil_time=60, mash_temp=152, mash_time=60,
            grain_bill=[
                {"name": "2-Row Pale Malt", "type": "base", "amount": 120, "unit": "lbs", "percentage": 72, "color": 2, "ppg": 37, "cost_per_lb": 0.65},
                {"name": "Flaked Oats", "type": "adjunct", "amount": 25, "unit": "lbs", "percentage": 15, "color": 1, "ppg": 33, "cost_per_lb": 0.80},
                {"name": "White Wheat", "type": "base", "amount": 17, "unit": "lbs", "percentage": 10, "color": 2, "ppg": 36, "cost_per_lb": 0.70},
                {"name": "Honey Malt", "type": "specialty", "amount": 5, "unit": "lbs", "percentage": 3, "color": 25, "ppg": 34, "cost_per_lb": 1.20},
            ],
            hop_schedule=[
                {"name": "Citra", "amount": 2, "unit": "oz", "alpha_acid": 12.0, "time": 60, "type": "bittering", "ibu_contribution": 28, "cost_per_oz": 0.35},
                {"name": "Mosaic", "amount": 3, "unit": "oz", "alpha_acid": 11.5, "time": 15, "type": "flavor", "ibu_contribution": 12, "cost_per_oz": 0.38},
                {"name": "Citra", "amount": 4, "unit": "oz", "alpha_acid": 12.0, "time": 0, "type": "aroma", "ibu_contribution": 5, "cost_per_oz": 0.35},
                {"name": "Mosaic", "amount": 3, "unit": "oz", "alpha_acid": 11.5, "time": 0, "type": "dry-hop", "ibu_contribution": 0, "cost_per_oz": 0.38},
                {"name": "Galaxy", "amount": 2, "unit": "oz", "alpha_acid": 14.0, "time": 0, "type": "dry-hop", "ibu_contribution": 0, "cost_per_oz": 0.42},
            ],
            yeast={"name": "London Ale III", "lab": "Wyeast", "strain": "1318", "attenuation_min": 73, "attenuation_max": 77, "flocculation": "medium-high", "temp_min": 64, "temp_max": 74, "pitch_rate": 0.75, "starter_needed": True, "cost_per_pack": 8.50, "packs_needed": 2},
            ...
            brew_history=[
                {"batch_number": "BH-2026-012", "date": "2026-02-25", "actual_og": 1.068, "actual_fg": 1.016, "qc_score": 92, "status": "fermenting"},
                {"batch_number": "BH-2026-003", "date": "2026-01-10", "actual_og": 1.067, "actual_fg": 1.014, "qc_score": 95, "status": "completed"},
            ],
        ...
        DetailedRecipe(id=_id("recipe-2"), beer_id=_id("beer-2"), name="Lone Star Lager", style="American Lager", category="flagship", version=2, batch_size=7, target_og=1.048, target_fg=1.010, target_abv=4.8, target_ibu=18, target_srm=3, boil_time=60, mash_temp=148, mash_time=60,
            grain_bill=[
                {"name": "Pilsner Malt", "type": "base", "amount": 100, "unit": "lbs", "percentage": 80, "color": 1.5, "ppg": 36, "cost_per_lb": 0.70},
                {"name": "Rice Hulls", "type": "adjunct", "amount": 15, "unit": "lbs", "percentage": 12, "color": 0, "ppg": 0, "cost_per_lb": 0.45},
                {"name": "Corn Grits", "type": "adjunct", "amount": 10, "unit": "lbs", "percentage": 8, "color": 1, "ppg": 37, "cost_per_lb": 0.50},
            ],
            hop_schedule=[
                {"name": "Hallertau", "amount": 1.5, "unit": "oz", "alpha_acid": 4.5, "time": 60, "type": "bittering", "ibu_contribution": 14, "cost_per_oz": 0.25},
                {"name": "Saaz", "amount": 1, "unit": "oz", "alpha_acid": 3.5, "time": 15, "type": "flavor", "ibu_contribution": 4, "cost_per_oz": 0.28},
            ],
            yeast={"name": "Mexican Lager", "lab": "Imperial", "strain": "L13", "attenuation_min": 73, "attenuation_max": 77, "flocculation": "medium", "temp_min": 50, "temp_max": 56, "pitch_rate": 1.5, "starter_needed": True, "cost_per_pack": 9.00, "packs_needed": 2},
            ...
            brew_history=[
                {"batch_number": "BH-2026-009", "date": "2026-02-15", "actual_og": 1.048, "actual_fg": 1.010, "qc_score": 94, "status": "completed"},
            ],
        ...
        DetailedRecipe(id=_id("recipe-3"), beer_id=_id("beer-3"), name="Bulverde Blonde", style="Cream Ale", category="flagship", version=4, batch_size=7, target_og=1.050, target_fg=1.012, target_abv=5.0, target_ibu=20, target_srm=4, boil_time=60, mash_temp=150, mash_time=60,
            grain_bill=[
                {"name": "2-Row Pale Malt", "type": "base", "amount": 95, "unit": "lbs", "percentage": 76, "color": 2, "ppg": 37, "cost_per_lb": 0.65},
                {"name": "Flaked Corn", "type": "adjunct", "amount": 20, "unit": "lbs", "percentage": 16, "color": 1, "ppg": 37, "cost_per_lb": 0.55},
                {"name": "Honey Malt", "type": "specialty", "amount": 10, "unit": "lbs", "percentage": 8, "color": 25, "ppg": 34, "cost_per_lb": 1.20},
            ],
            hop_schedule=[
                {"name": "Cascade", "amount": 1, "unit": "oz", "alpha_acid": 5.5, "time": 60, "type": "bittering", "ibu_contribution": 16, "cost_per_oz": 0.22},
                {"name": "Mt. Hood", "amount": 0.5, "unit": "oz", "alpha_acid": 4.0, "time": 5, "type": "aroma", "ibu_contribution": 4, "cost_per_oz": 0.24},
            ],
            yeast={"name": "American Ale", "lab": "Fermentis", "strain": "US-05", "attenuation_min": 78, "attenuation_max": 82, "flocculation": "medium", "temp_min": 59, "temp_max": 75, "pitch_rate": 0.75, "starter_needed": False, "cost_per_pack": 4.50, "packs_needed": 2},
            ...
            brew_history=[
                {"batch_number": "BH-2026-011", "date": "2026-02-20", "actual_og": 1.049, "actual_fg": 1.011, "qc_score": 96, "status": "completed"},
            ],
        ...
        DetailedRecipe(id=_id("recipe-4"), beer_id=_id("beer-6"), name="Prickly Pear Sour", style="Berliner Weisse", category="seasonal", version=2, batch_size=7, target_og=1.042, target_fg=1.008, target_abv=4.2, target_ibu=5, target_srm=4, boil_time=15, mash_temp=148, mash_time=60,
            grain_bill=[
                {"name": "Pilsner Malt", "type": "base", "amount": 65, "unit": "lbs", "percentage": 60, "color": 1.5, "ppg": 36, "cost_per_lb": 0.70},
                {"name": "White Wheat", "type": "base", "amount": 35, "unit": "lbs", "percentage": 32, "color": 2, "ppg": 36, "cost_per_lb": 0.70},
                {"name": "Acidulated Malt", "type": "specialty", "amount": 9, "unit": "lbs", "percentage": 8, "color": 2, "ppg": 27, "cost_per_lb": 1.50},
            ],
            hop_schedule=[
                {"name": "Hallertau", "amount": 0.5, "unit": "oz", "alpha_acid": 4.5, "time": 15, "type": "bittering", "ibu_contribution": 5, "cost_per_oz": 0.25},
            ],
            yeast={"name": "Philly Sour", "lab": "Lallemand", "strain": "WLP-PS", "attenuation_min": 75, "attenuation_max": 85, "flocculation": "low", "temp_min": 68, "temp_max": 77, "pitch_rate": 0.75, "starter_needed": False, "cost_per_pack": 6.00, "packs_needed": 2},
            ...
            brew_history=[
                {"batch_number": "BH-2026-007", "date": "2026-02-10", "actual_og": 1.043, "actual_fg": 1.009, "qc_score": 90, "status": "completed"},
            ],
        ...
        DetailedRecipe(id=_id("recipe-5"), beer_id=_id("beer-10"), name="Barrel-Aged Imperial Stout", style="Imperial Stout", category="limited", version=1, batch_size=7, target_og=1.110, target_fg=1.030, target_abv=11.5, target_ibu=65, target_srm=40, boil_time=90, mash_temp=156, mash_time=75,
            grain_bill=[
                {"name": "Maris Otter", "type": "base", "amount": 120, "unit": "lbs", "percentage": 60, "color": 3, "ppg": 38, "cost_per_lb": 0.85},
                {"name": "Chocolate Malt", "type": "specialty", "amount": 20, "unit": "lbs", "percentage": 10, "color": 350, "ppg": 28, "cost_per_lb": 1.10},
                {"name": "Roasted Barley", "type": "specialty", "amount": 16, "unit": "lbs", "percentage": 8, "color": 500, "ppg": 25, "cost_per_lb": 1.10},
                {"name": "Crystal 120", "type": "specialty", "amount": 14, "unit": "lbs", "percentage": 7, "color": 120, "ppg": 33, "cost_per_lb": 1.15},
                {"name": "Flaked Oats", "type": "adjunct", "amount": 20, "unit": "lbs", "percentage": 10, "color": 1, "ppg": 33, "cost_per_lb": 0.80},
                {"name": "Black Patent", "type": "specialty", "amount": 10, "unit": "lbs", "percentage": 5, "color": 500, "ppg": 25, "cost_per_lb": 1.15},
            ],
            hop_schedule=[
                {"name": "Magnum", "amount": 3, "unit": "oz", "alpha_acid": 14.0, "time": 90, "type": "bittering", "ibu_contribution": 55, "cost_per_oz": 0.28},
                {"name": "East Kent Goldings", "amount": 2, "unit": "oz", "alpha_acid": 5.0, "time": 15, "type": "flavor", "ibu_contribution": 10, "cost_per_oz": 0.30},
            ],
            yeast={"name": "London ESB", "lab": "Wyeast", "strain": "1968", "attenuation_min": 67, "attenuation_max": 71, "flocculation": "high", "temp_min": 64, "temp_max": 72, "pitch_rate": 1.0, "starter_needed": True, "cost_per_pack": 8.50, "packs_needed": 4},
            ...
            brew_history=[
                {"batch_number": "BH-2025-045", "date": "2025-11-01", "actual_og": 1.108, "actual_fg": 1.028, "qc_score": 97, "status": "aging"},
            ],
        ...
        DetailedRecipe(id=_id("recipe-6"), name="Spring Saison", style="Saison", category="seasonal", version=1, batch_size=7, target_og=1.062, target_fg=1.006, target_abv=7.2, target_ibu=28, target_srm=5, boil_time=90, mash_temp=148, mash_time=75,
            grain_bill=[
                {"name": "Pilsner Malt", "type": "base", "amount": 100, "unit": "lbs", "percentage": 75, "color": 1.5, "ppg": 36, "cost_per_lb": 0.70},
                {"name": "White Wheat", "type": "base", "amount": 20, "unit": "lbs", "percentage": 15, "color": 2, "ppg": 36, "cost_per_lb": 0.70},
                {"name": "Munich Malt", "type": "base", "amount": 13, "unit": "lbs", "percentage": 10, "color": 10, "ppg": 34, "cost_per_lb": 0.75},
            ],
            hop_schedule=[
                {"name": "Styrian Goldings", "amount": 1.5, "unit": "oz", "alpha_acid": 5.5, "time": 60, "type": "bittering", "ibu_contribution": 22, "cost_per_oz": 0.28},
                {"name": "Saaz", "amount": 1, "unit": "oz", "alpha_acid": 3.5, "time": 5, "type": "aroma", "ibu_contribution": 6, "cost_per_oz": 0.28},
            ],
            yeast={"name": "Belgian Saison", "lab": "Wyeast", "strain": "3724", "attenuation_min": 76, "attenuation_max": 80, "flocculation": "low", "temp_min": 70, "temp_max": 95, "pitch_rate": 0.75, "starter_needed": True, "cost_per_pack": 8.50, "packs_needed": 2},
            ...
            brew_history=[
                {"batch_number": "BH-2026-013", "date": "2026-02-28", "actual_og": 1.062, "actual_fg": 1.008, "qc_score": 88, "status": "fermenting"},
            ],
    ...
    today = date.today()
    brew_day_logs = [
        BrewDayLog(id=_id("brewday-1"), batch_id=_id("batch-1"), scheduled_date=date(2026, 2, 25), actual_start=datetime(2026, 2, 25, 6, 0), actual_end=datetime(2026, 2, 25, 14, 30), brewer_id=_id("staff-1"), brewer_name="Mike Rodriguez", mash_temp_f=152.0, mash_duration_min=60, boil_duration_min=60, pre_boil_gravity=1.058, original_gravity=1.068, post_boil_volume_gal=217, notes="Smooth brew day, hit all targets", status="completed"),
        BrewDayLog(id=_id("brewday-2"), batch_id=_id("batch-2"), scheduled_date=date(2026, 2, 28), actual_start=datetime(2026, 2, 28, 6, 0), actual_end=datetime(2026, 2, 28, 14, 0), brewer_id=_id("staff-1"), brewer_name="Mike Rodriguez", mash_temp_f=148.0, mash_duration_min=75, boil_duration_min=90, pre_boil_gravity=1.052, original_gravity=1.062, post_boil_volume_gal=217, notes="Extended mash for dryness", status="completed"),
        BrewDayLog(id=_id("brewday-3"), batch_id=_id("batch-3"), scheduled_date=date(2026, 2, 20), actual_start=datetime(2026, 2, 20, 7, 0), actual_end=datetime(2026, 2, 20, 15, 0), brewer_id=_id("staff-1"), brewer_name="Mike Rodriguez", mash_temp_f=150.0, mash_duration_min=60, boil_duration_min=60, pre_boil_gravity=1.042, original_gravity=1.049, post_boil_volume_gal=217, notes="Added peaches on day 5", status="completed"),
        BrewDayLog(id=_id("brewday-4"), batch_id=_id("batch-4"), scheduled_date=date(2026, 3, 1), actual_start=datetime(2026, 3, 1, 6, 30), actual_end=datetime(2026, 3, 1, 14, 0), brewer_id=_id("staff-1"), brewer_name="Mike Rodriguez", mash_temp_f=154.0, mash_duration_min=60, boil_duration_min=60, pre_boil_gravity=1.060, original_gravity=1.072, post_boil_volume_gal=434, notes="Double batch for summer stock", status="completed"),
